...
// See https://github.com/XuanMaoSecLab/DolphinChain/blob/0.1/docs/sts-final.pdf for
...
// (TODO(ismail): see also https://github.com/XuanMaoSecLab/DolphinChain/issues/3010)
...
func computeDHSecret(remPubKey, locPrivKey *[32]byte) (shrKey *[32]byte, err error) {
	...
	// related to: https://github.com/XuanMaoSecLab/DolphinChain/issues/3010
	zero := new([32]byte)
