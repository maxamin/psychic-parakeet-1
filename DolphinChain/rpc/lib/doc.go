...
// Examples
//
// - [Tendermint](https://github.com/XuanMaoSecLab/DolphinChain/blob/master/rpc/core/routes.go)
// - [tm-monitor](https://github.com/XuanMaoSecLab/DolphinChain/blob/master/tools/tm-monitor/rpc.go)
package rpc
