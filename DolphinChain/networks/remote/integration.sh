...
REPO=github.com/XuanMaoSecLab/DolphinChain
go get $REPO
cd $GOPATH/src/$REPO
...
cd $GOPATH/src/github.com/XuanMaoSecLab/DolphinChain/networks/remote/terraform
...
cd $GOPATH/src/github.com/XuanMaoSecLab/DolphinChain/networks/remote/ansible

ansible-playbook -i inventory/digital_ocean.py -l sentrynet install.yml
ansible-playbook -i inventory/digital_ocean.py -l sentrynet config.yml -e BINARY=$GOPATH/src/github.com/XuanMaoSecLab/DolphinChain/build/tendermint -e CONFIGDIR=$GOPATH/src/github.com/XuanMaoSecLab/DolphinChain/docs/examples
...
old_ansible_file=$GOPATH/src/github.com/XuanMaoSecLab/DolphinChain/networks/remote/ansible/roles/install/templates/systemd.service.j2
rm $old_ansible_file
