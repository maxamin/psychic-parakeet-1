...
describe('[Challenge] Side entrance', function () {
    ...
    it('Exploit', async function () {
        ...
        const AttackSideEntranceFactory = await ethers.getContractFactory('FlashLoanEtherReceiver', attacker);
        this.attack = await AttackSideEntranceFactory.deploy(this.pool.address, ETHER_IN_POOL);

        await this.attack.attack(attacker.address);
